...
if ENV:
    ...
    from ShoyoBOT.config import Development as Config
    TOKEN = Config.TOKEN
...
from ShoyoBOT.modules.helper_funcs.handlers import (CustomCommandHandler,

...
from ShoyoBOT import MONGO_DB_URI
from ShoyoBOT import telethn
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import ShoyoBOT.tevents

        path = Path(f"ShoyoBOT/modules/{shortname}.py")
        name = "ShoyoBOT.modules.{}".format(shortname)

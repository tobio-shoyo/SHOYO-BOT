...
from ShoyoBOT import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
                          OWNER_ID, PORT, SUPPORT_CHAT, TOKEN, URL, WEBHOOK,
                          dispatcher, StartTime, telethn, updater, pgram, BOT_USERNAME, BOT_NAME)

from ShoyoBOT.resources.imagefiles import SHOYO_START_IMG, SHOYO_HELP_IMG, SHOYO_IMG
from ShoyoBOT.modules import ALL_MODULES
from ShoyoBOT.modules.helper_funcs.chat_status import is_user_admin
from ShoyoBOT.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = f"""
This is {BOT_NAME}[.]({SHOYO_START_IMG})
...
HELP_STRINGS = f"""
`Hey there! My name is` [{BOT_NAME}]({SHOYO_HELP_IMG}) 
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ShoyoBOT.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            SHOYO_IMG, caption= "<code>{} is Here For You❤\nI am Awake Since</code>: <code>{}</code>".format(
                BOT_NAME, uptime
            ),

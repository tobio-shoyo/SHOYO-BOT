...
import ShoyoBOT.modules.sql.global_bans_sql as gban_sql
import ShoyoBOT.modules.sql.users_sql as user_sql
from ShoyoBOT import DEV_USERS, OWNER_ID, dispatcher
